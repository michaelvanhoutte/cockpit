# Unified Inbox & Dashboards — Functional Definition (v0.6)
...
- If you replied but now need to make sure something happens (you are awaiting their answer or a result) → the item moves to a **Waiting / Follow-up** state, it **stays** in the Panel, and its next-action label **rewrites itself** to the new step: *"Reply to Dave's question on Part 11"* becomes *"Follow up: awaiting Dave's answer on Part 11."*
