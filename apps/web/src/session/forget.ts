 ...
 *   question a new account opens on has been answered, all six in
 *   localStorage - the last five of them because leaving one behind gives the
 *   first person's answer to the second;
