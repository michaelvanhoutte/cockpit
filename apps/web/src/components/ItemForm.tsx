    ...
    >
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className="fixed left-1/2 top-1/2 flex max-h-[min(44rem,calc(100vh_-_2rem_-_var(--edge-top)_-_var(--edge-bottom)))] w-[min(42rem,calc(100vw-2rem))] -translate-x-1/2 -translate-y-1/2 flex-col rounded-lg border border-black/10 bg-surface p-5 shadow-lg"
        >
