...
- **Starting the app** (needed by the definition of done): `pnpm dev`, or `pnpm dev:api` on :8787 and `pnpm dev:web` on :5173. Full sequence in [readme.md](../../../readme.md).
