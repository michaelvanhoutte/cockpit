...
├── .github/           # CI, CodeQL, the Claude workflow, the two deploy workflows, branch protection
...
# health check, the diff classifier, and the writing rules over
