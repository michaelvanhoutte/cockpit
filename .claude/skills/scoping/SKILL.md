...
- **What is actually in each environment?** Read the deploy workflows rather than assuming, because they differ on purpose: preview is re-seeded on every deploy, staging deliberately never is, and production was seeded once by hand.
