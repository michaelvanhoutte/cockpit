...
const ITEMS = [
    ...
    { id: 'i1', src: 'slack', from: 'DM · Anna Duval', subject: 'appointment with Novy', time: 'Jun 12', action: 'Make appointment with Novy', summary: 'Anna asks to pick a date and send it straight to Pieter Claes at Novy (Anna is on leave next week).', due: 'none', status: 'inbox', unseen: true, url: 'https://example.slack.com/archives/C0000000000/p0000000000000000' },
