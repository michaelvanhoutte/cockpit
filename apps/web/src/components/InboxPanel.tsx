...
export function InboxPanel({ workspaceId }: { workspaceId: string }) {
  ...
  if (isLoading || !data) {
    return <p className="px-4 py-3 text-ink-faint">Loadingâ€¦</p>;
  }
  ...
  // no filings at all â€” which should be an Inbox holding everything, the way it
