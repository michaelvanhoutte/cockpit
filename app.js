...
const ITEMS = [
    { id: 'i1', src: 'mail', from: 'Tom Whitfield · Atlas Copco', subject: 'Re: Part 11 compatibility of the audit trail', time: '08:12', action: "Reply to Tom's question on Part 11 compatibility", summary: 'Tom asks whether the audit-trail export satisfies 21 CFR Part 11 for their validated line. Five of six questions are answered in the validation pack; the open one is e-signature retention.', suggest: 'Atlas Copco rollout', due: 'due', dueLabel: 'Due today', status: 'inbox', unseen: false },
    ...
    { id: 'i3', src: 'notion', from: 'Lena Hartmann', subject: 'Inbox spec v0.3 — comments', time: 'Yesterday', action: "Resolve Lena's three comments on the item model", summary: 'All three sit in §3.2: whether a task is a status or its own object, and two naming nits.', suggest: 'Inbox spec v0.3', due: 'none', dueLabel: 'No date', status: 'inbox', unseen: false },
    ...
    { id: 'i5', src: 'whatsapp', from: 'Ruben Maes', subject: 'quick one about the Ghent line', time: '07:20', action: 'Send Ruben the Ghent line timeline he asked for', summary: 'Voice note, 40 seconds. He wants the pilot dates before he talks to his plant manager.', suggest: 'Atlas Copco rollout', due: 'soon', dueLabel: 'Tomorrow', status: 'inbox', unseen: true },
    ...
    { id: 'a1', src: 'mail', from: 'Tom Whitfield', subject: 'Part 11 audit trail', time: 'Tue', action: "Follow up: awaiting Tom's answer on e-signature retention", due: 'soon', dueLabel: 'Fri', status: 'waiting', panel: 'atlas' },
    ...
    { id: 'a3', src: 'slack', from: '#cust-atlascopco · Joris', subject: 'line 3 downtime', time: '07:55', action: 'Check the downtime figures Joris posted', due: 'none', dueLabel: 'Auto-routed', status: 'task', panel: 'atlas', unseen: true },
    ...
    { id: 's2', src: 'notion', from: 'Lena Hartmann', subject: 'v0.3 review', time: 'Yesterday', action: 'Rewrite §4.1 with the hybrid routing decision', due: 'soon', dueLabel: 'This week', status: 'task', panel: 'spec' },
    ...
    { id: 'h2', src: 'whatsapp', from: 'Marie Janssen', subject: 'referral', time: 'Sun', action: "Reply to Marie's referral for the ops role", due: 'soon', dueLabel: 'Tomorrow', status: 'task', panel: 'hiring' },
    ...
    { id: 't1', src: 'internal', from: 'You', subject: 'own action', time: '—', action: 'Lena — discuss rollout ownership in the next 1:1', due: 'soon', dueLabel: 'Thu 1:1', status: 'task', panel: 'team' },
    ...
    { id: 't3', src: 'internal', from: 'You', subject: 'own action', time: '—', action: 'Give Joris feedback on the downtime report', due: 'due', dueLabel: 'Today', status: 'task', panel: 'team' },
    ...
    { id: 'b1', src: 'mail', from: 'Helena (chair)', subject: 'September board pack', time: 'Fri', action: 'Send the September board pack outline', due: 'soon', dueLabel: 'Next week', status: 'task', panel: 'board' },
    ...
    { id: 'r3', src: 'whatsapp', from: 'Ruben Maes', subject: 'article', time: '—', action: 'Read the MES integration article Ruben sent', due: 'none', dueLabel: 'No date', status: 'task', panel: 'reading' },
    { id: 'o1', src: 'mail', from: 'Ruben Maes', subject: 'pilot on hold', time: '—', action: 'Revisit the Ghent pilot in September', due: 'none', dueLabel: 'Sept', status: 'snoozed', panel: 'onhold' },
