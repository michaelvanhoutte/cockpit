...
- **Layout** — one named arrangement of a Dashboard's Panels — their order and each one's size — together with the screen width it was made at. A Dashboard can have several, so it reads well on a phone and on a 4K screen; you pick which by name from the Dashboard's own bar, and *Automatic* draws the one closest to the screen in front of you.
