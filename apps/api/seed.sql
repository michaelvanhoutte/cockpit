...
INSERT OR IGNORE INTO workspaces (id, tenant_id, name, folded_name, slug, color, created_at) VALUES
  ('ws-work', 'tenant-default', 'Work', 'work', 'work', '#6f62b5', '2026-08-12T00:00:01.000Z'),
  ('ws-atlas', 'tenant-default', 'Atlas Copco', 'atlas copco', 'atlas', '#3a72c8', '2026-08-12T00:00:02.000Z'),
  ('ws-personal', 'tenant-default', 'Personal', 'personal', 'personal', '#c06a45', '2026-08-12T00:00:03.000Z');
