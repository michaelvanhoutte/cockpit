...
const ITEMS = [
    ...
    { id: 'i3', src: 'notion', from: 'Lena Hartmann', subject: 'Inbox spec v0.3 — comments', time: 'Yesterday', action: "Resolve Lena's three comments on the item model", summary: 'All three sit in §3.2: whether a task is a status or its own object, and two naming nits.', suggest: 'Inbox spec v0.3', due: 'none', status: 'inbox', unseen: false },
    ...
    { id: 'i5', src: 'whatsapp', from: 'Ruben Maes', subject: 'quick one about the Ghent line', time: '07:20', action: 'Send Ruben the Ghent line timeline he asked for', summary: 'Voice note, 40 seconds. He wants the pilot dates before he talks to his plant manager.', suggest: 'Atlas Copco rollout', due: 'none', status: 'inbox', unseen: true },
    ...
    { id: 's2', src: 'notion', from: 'Lena Hartmann', subject: 'v0.3 review', time: 'Yesterday', action: 'Rewrite §4.1 with the hybrid routing decision', due: 'none', status: 'task', panel: 'spec' },
    ...
    { id: 't3', src: 'internal', from: 'You', subject: 'own action', time: '—', action: 'Give Joris feedback on the downtime report', due: 'none', status: 'task', panel: 'team' },
    ...
    { id: 'r3', src: 'whatsapp', from: 'Ruben Maes', subject: 'article', time: '—', action: 'Read the MES integration article Ruben sent', due: 'none', status: 'task', panel: 'reading' },
