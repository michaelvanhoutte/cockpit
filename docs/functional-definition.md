...
- **Filing.** Any Item can be filed onto a Panel from its own menu, which is what takes it out of the Inbox ("The Inbox and the triage flow"). An Item filed on several Panels appears on all of them.
