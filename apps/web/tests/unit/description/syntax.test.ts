...
describe('Item editing', () => {
  describe('a description comes back as it was written', () => {
    ...
    it.each([
      ...
      { situation: 'an image from the web', written: '![the panel](https://example.com/p.png)', kept: '![the panel](https://example.com/p.png)\n' },
      { situation: 'an image attached to the item', written: 'Before\n\n![photo.png](/v1/attachments/0199a1b2-c3d4-7e5f-8a9b-0c1d2e3f4a5b)\n\nAfter', kept: 'Before\n\n![photo.png](/v1/attachments/0199a1b2-c3d4-7e5f-8a9b-0c1d2e3f4a5b)\n\nAfter\n' },
